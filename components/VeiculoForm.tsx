...
export default function VeiculoForm({
  ...
  const [combustivel, setCombustivel] = useState<"ETANOL" | "GASOLINA">(
    "GASOLINA",
  );
  ...
  const handleSubmit = () => {
    if (!nome.trim() || !capacidade || !odometro) {
      Alert.alert(
        "Atenção",
        "Preencha todos os campos para cadastrar o veículo.",
      );
      return;
    }
  ...
  return (
    <View style={styles.cardFormulario}>
      ...
      <View>
        <Text style={styles.miniLabel}>Nome do veículo:</Text>
        <TextInput
      ...
      <View style={styles.row}>
        <View style={{ width: "48%" }}>
          <Text style={styles.miniLabel}>Capacidade Tanque (L):</Text>
          <TextInput
        ...
        <View style={{ width: "48%" }}>
          <Text style={styles.miniLabel}>Odômetro Atual (KM):</Text>
          <TextInput
          ...
          <View style={styles.rowBotoesCombustivel}>
            <TouchableOpacity
              style={[
                ...
                combustivel === "ETANOL" && styles.ativoEtanol,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.botaoCombustivel,
                combustivel === "GASOLINA" && styles.ativoGasolina,
              ]}
